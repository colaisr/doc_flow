...
# AuditLog removed - not needed for CRM
...
async def get_admin_settings(
    ...
    # Global API keys (simplified - no longer using AppSettings)
    global_api_keys = {
        "openrouter_fallback_key": None,
        "openrouter_fallback_key_masked": None,
    }
...
async def update_global_api_keys(
    ...
    # Simplified - no longer storing API keys in database
    return {
        "success": True,
        "message": "Global API keys feature not available in simplified version"
    }
...
async def get_user_details(
    ...
    # Calculate statistics (simplified - no business logic metrics)
    statistics = UserStatisticsResponse(
        tokens_used_total=0,
        tokens_used_this_month=0,
        pipelines_created_total=0,
        pipelines_active=0,
        runs_executed_total=0,
        runs_executed_this_month=0,
        runs_succeeded=0,
        runs_failed=0,
...
async def get_user_activity(
    ...
    # Activity log simplified - no business logic activities
    activity = []
    return activity
...
async def impersonate_user(
    ...
    # Audit logging removed - not needed for CRM
